...
public class State {
    ...
    //plainValue is not null only when there is no unknown_sig wire
    ...
    //the plainValue and the wires{StaticWire} can be transformed 
    ...
    //only want parts of the wires in State s, from index start to index end
