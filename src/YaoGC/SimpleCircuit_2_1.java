...
/*
 * parent class for And Or...
 * build() only create input and output
 * where observer was first initialized
 * a wire is observed by a SimpleCircuit_2_1 class and a socket
 */
public abstract class SimpleCircuit_2_1 extends Circuit {
    ...
    protected void createInputWires() {
        ...
        for (int i = 0; i < inDegree; i++)
        	//this is where observer was first added
    ...
    /*
     * the situation where And Or can get a quick result
     * say for or, if one input is 1, the result is definitely 1
     */
